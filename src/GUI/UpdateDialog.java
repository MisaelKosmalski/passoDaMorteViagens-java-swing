...
public class UpdateDialog extends javax.swing.JDialog {
	...
	private void initComponents() {
        	...
        	layout.setHorizontalGroup(
                ...
                .addGroup(layout.createSequentialGroup()
                .addComponent(btnClean, javax.swing.GroupLayout.PREFERRED_SIZE, 75, javax.swing.GroupLayout.PREFERRED_SIZE)							        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
	...
	public void fieldsUpdate(){
        	ftfName.setText(traveler.getName());
        	ftfCpf.setText(traveler.getCpf());
        	ftfNumber.setText(traveler.getNumberPhone());
        	ftfBoarding.setText(traveler.getBoarding());
        	ftfDestiny.setText(traveler.getDestiny());
    	}
